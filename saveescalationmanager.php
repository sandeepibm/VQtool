...
<title>Save Escalation Manager</title>
...
<tr><td  height='23'>
<b><center>Save Escalation Manager's Email</font></center></b>
</td></tr>
</table>
<br></br>
...
<?php
      ...
      if (!$name) {
		echo "<table width='60%' border='0' align='right' valign='top'>
				<tr><td>
				<font face='Tahoma' size='2' color='FF0000'>Please enter Escalation Manager's Name.</font>
				</td></tr>
			</table>";		  
      }			
      if (!$email) {
		echo "<table width='60%' border='0' align='right' valign='top'>
				<tr><td>
				<font face='Tahoma' size='2' color='FF0000'>Please enter Escalation Manager's Email.</font>
				</td></tr>
			</table>";		  
      }		  
...
*/	
	  ...
	  mysql_query("Truncate Table tblescalationmatrix");
      mysql_query("INSERT INTO tblescalationmatrix(Name, Email) VALUES('".mysql_real_escape_string($name)."','".mysql_real_escape_string($email)."')");
	  ...
	  echo "<table border='0' align='center' valign='middle'>
			<tr><td  align='center'>
			<b><font face='Verdana' Size='2' color='848484'>Escalation Manager's Email has been set successfully.</font></b>
			</td></tr>
			</table>";
			
	header("Location: setescalationmanager.php");	
