...
<title>In Process Request Details Escalate</title>
...
<!-- Form starts -->
<form name ='form1' action='escalateinprocessrequest.php?reqId=$Id' method='POST' onSubmit='javascript: return validate_form();'>
...
<font face='Tahoma' size='2' color='B40486'>Click on<i> Escalate </i> to escalate the request to 'Escalate To'.</font></center>
</td></tr>
</table>
<br></br>
...
<tr>
  <td align='right'><b><font face='Tahoma' size='2' color='44778D'>Escalate To:</font></b></td>";
	$Qry=mysql_query("SELECT Id,Name,Email FROM tblescalationmatrix") or die(mysql_error());  
	While ($row = mysql_fetch_array($Qry))
	{
		$escName=$row['Name'];	
		$escEmail=$row['Email'];
	}
echo "<td align='left'><input type='text' name='email' id='email' size='63' readonly='true' style='border:1px solid #378EF1; color:#5D5F60; background:#ddd; font-weight:500; font-family:Tahoma' value='$escName ($escEmail)'></td>
</tr>
<tr>
...
<tr>                
		...
		<button type='Submit' name='Submit' id='Submit' onClick="document.getElementById('soundfile').play();">Escalate</button>
		<?php 	echo "	</td>
</tr>
</table>
</form>
