...
<tr><td  height='23'>
<b><center>Save Type</font></center></b>
</td></tr>
</table>
<br></br>
...
*/
	  ...
	  $seqinuse = mysql_query("SELECT * FROM dropdownmenus WHERE dropdownname='RequestType' and dropdownSequence=$sequence");
	  $isseqinuse = mysql_num_rows($seqinuse);
	  // If sequence number exists then print error message and exit script
	  If ($isseqinuse == 1) {
		  echo "<center><font face='Verdana' Size='2' color='FF0000'>The Sequence you entered already exists.</font></center>";
      ...
      mysql_query("INSERT INTO dropdownmenus (dropdownName, dropdownItemName, dropdownSequence, CreatedBy, CreatedOn) Values('RequestType','".mysql_real_escape_string($name)."',$sequence,'$username',Now())");

      // Print Successful Creation of user message

	  echo "<table border='0' align='center' valign='middle'>
			<tr><td  align='center'>
			<b><font face='Verdana' Size='2' color='848484'>Type has been created successfully.</font></b>
			</td></tr>
			</table>";
	  echo "<br><br><br><br>";
      echo "<a href='createtype.php'><center><font size='3'>Back</font></center></a>";

	header("Location: createtype.php");	  
  //}
  //}
