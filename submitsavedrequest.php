...
<title>Save Request Submitted</title>
...
<tr><td  height='36'>
<b><center>Submit Saved Request</font></center></b>
</td></tr>
</table>
<br></br>
<?php
...
else
{
	...
	echo "<table border='0' align='center' valign='top'>
		...
		$prevColors="#04B431";		  
		 ...
		 mysql_query("Update savedrequests Set Status='Submitted' Where SavedId=$savedId") or die(mysql_error());
		 
		echo 
		"			
		 <table border='0'  id='table1'  cellspacing='0' align='center'>
		 <tr>
		 ...
		 <tr><td><br></br></td></tr>
		 <tr>
		 <td colspan='2' height='30'><label><font face='Tahoma' size='2'><center> This is the request you have submitted. </center></font></td>
		 </tr>
		 </table>
        ...
        <tr>               
                <td width='120' align='right'><b><font face='Tahoma' size='2' color='44778D'>Description : </b></td>
        ...
        <tr>                
                <td width='120' align='right'><b><font face='Tahoma' size='2' color='44778D'>On : </b></td>
		...
		<tr>
		<td colspan='2'><label><font face='Tahoma' size='2'><center>Your Request Number is <font color='B40486'><b>$id</b></font>. Kindly note this for your further reference.</center></font></td>
		</tr>
        </table>		
		"
		;
