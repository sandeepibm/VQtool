...
<tr><td height='23'>
<?php echo "<b><center>Pending Tickets of $nameuser </font></center></b>"; ?>
</td></tr>
</table>
<br></br>
...
<?php
	  ...
	  $result=mysql_query("SELECT A.RequestId,B.UserName,A.Type,A.Subtype,A.Subject,A.SLA_Days,A.CreatedOn,A.Status FROM allrequests A,userdata B WHERE A.UserId = B.UserId AND B.UserId = '$namecookie' And Status = 'Pending' ORDER BY A.CreatedOn DESC") or die(mysql_error());
?>

<table border="0" align="center" valign="top">
<tr><td style='background:#FFF'><center>
<p align="center"><font face='Tahoma' size='2' color='B40486'>Click on the <i> Request No </i> to update a request.</font></p></center>
</td></tr>
</table>
<br></br>
...
<table border="1" id="table4" class='stats' colspace='0' align="center" width=80%>
        <tr>
		<th >Request No</th><th >Username</th><th>Type</th><th>Subtype</th><th>Subject</th><th>SLA</th><th>Request Date</th><th>Status</th>  
		</tr><tr>
		<?php
			//echo "$nameuser";
			//$value = $_POST['posts'];
			while($row=mysql_fetch_array($result)){
				echo "</td><td width=7%>";
				echo "<a href='pendingrequestdetails.php?ReqId=$row[0]' title='Click to Update'>$row[0]</a>";
				echo "</td><td width=7%>";
				echo $row[1];
				echo "</td><td width=18%>";
				echo $row[2];
