...
<title>Closed Request Details Rated</title>
...
<font face='Tahoma' size='2' color='B40486'>Here you are viewing the details of a request which is Closed. For other Requests, you've different screens. </font></center>
</td></tr>
</table>
<br></br>
...
// <tr>
  ...
  // Get all the type of requests from the database and allow user to choose one
	...
	While ($rowRequest = mysql_fetch_array($ReqIdQuery))
	{
		...
		$Rating=$rowRequest['Rating'];
		$Severity=$rowRequest['Severity'];
		$RatingRem=$rowRequest['RatingRemarks'];
	}
		...
		$SeverityDesc='('.$infoSeverity['Sequence'].')'.$infoSeverity['Description'];	
	  	...
	  	// for Rating
		$query_Rating=mysql_query("Select * From tblrating Where Id=$Rating");
		$infoRating=mysql_fetch_array($query_Rating) ;
		$RatingDesc='('.$infoRating['Sequence'].')'.$infoRating['Description'];	
...
<tr>
  <td align='right'><b><font face='Tahoma' size='2' color='44778D'>Rating :</font></b></td>
  <td align='left'><label><font face='Tahoma' size='2'>$RatingDesc</font></td>
</tr>
<tr>
  <td align='right'><b><font face='Tahoma' size='2' color='44778D'>Rating Remarks :</font></b></td>
  <td align='left'><label><font face='Tahoma' size='2'>$RatingRem</font></td>
</tr>
<tr>
	<td>
		<br></br><br></br>
