...
<tr><td  height='23'>
<b><center>Update Status</font></center></b>
</td></tr>
</table>
<br></br>
...
<?php
	  if ((!$name)||(!$Id)) {
		...
		echo "<table width='60%' border='0' align='right' valign='top'>
				<tr><td>
				<font face='Tahoma' size='2' color='FF0000'>Please Enter Status.</font>
				</td></tr>
			</table>";
		  }
		  if (!$Id) {
...
*/
      ...
      mysql_query("UPDATE tblstatus SET Status='".mysql_real_escape_string($name)."' WHERE StatusId=$Id");

      // Print Successful Creation of user message

	  echo "<table border='0' align='center' valign='middle'>
			<tr><td  align='center'>
			<b><font face='Verdana' Size='2' color='848484'>Status has been updated successfully.</font></b>
			</td></tr>
			</table>";
	  echo "<br><br><br><br>";
      echo "<a href='editstatus.php'><center><font size='3'>Back</font></center></a>";
